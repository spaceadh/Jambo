...
For loops are a fundamental control structure in Jambo, used for iterating over iterable objects such as strings, arrays, and dictionaries. This page covers the syntax and usage of for loops in Jambo, including key-value pair iteration, and the use of break and continue statements.
...
Jambo allows you to iterate over both the value or the key-value pair of an iterable. To iterate over just the values, use one temporary identifier:
